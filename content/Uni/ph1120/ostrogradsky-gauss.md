...
chapter: 1
unit: 6
title: Định lý Ostrogradsky-Gauss
---

# Định lý Ostrogradsky-Gauss (OG)
## Vector điện cảm
- là đại lượng vector đặc trưng cho tính chất của [[dien_truong|điện trường]] _không phụ thuộc vào môi trường_
...
## Điện thông
- là đại lượng vô hướng biểu thị số đường sức từ gửi qua một mặt $S$
- Để xác định điện thông gửi qua mặt $S$, ta chia $S$ thành các mảnh $\mathrm{d}S$ vô cùng nhỏ, trên các mạnh này từ trường là từ trường đều.
...
- Kết quả này phù hợp với công thức thu được từ [[dien_truong#Nguyên lí chồng chất điện trường. Điện trường của hệ điện tích|Nguyên lí chồng chất điện trường]]
