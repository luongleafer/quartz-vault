...
- Đặt $q_2$ trong [[dien_truong|điện trường]] của $q_1$, [[dien_the#^thenang|thế năng]] của $q_2$ trong điện trường của $q_1$ cũng bằng thế năng của $q_1$ trong điện trường của $q_2$
