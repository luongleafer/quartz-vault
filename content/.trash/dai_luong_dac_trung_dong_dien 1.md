...
- Xét khối [[vat_dan|vật dẫn]] có [[dien_the 1|điện thế]] hai đầu là $V$ và $V+dV (dV < 0)$, chiều dài $dl$, diện tích $dS$
- Với dòng điện một chiều, không đổi, ta có
$$I = \frac{U}{R} = \frac{V_1-V_2}{R}$$
- Với dòng điện biến đổi, chia vật thành các vi phân mà trong mỗi khối vi phân đó, [[dien_truong 1|điện trường]] là điện trường đều, ta có
$$dI = \frac{-dV}{R}$$
Ta có:
$$R = \frac{\rho dl}{dS}$$
vậy
